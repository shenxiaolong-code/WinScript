...
Create the 16 and 8 bit cpu registers (gdb dont have them by default)
...
You can safely use it instead nexti or n since it will single step code if it is not a call instruction (unless you want to go into the call function)
end
